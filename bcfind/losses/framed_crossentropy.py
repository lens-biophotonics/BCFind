...
@tf.keras.utils.register_keras_serializable(package='BCFind', name='FramedCrossentropy3D')
class FramedCrossentropy3D(tf.keras.losses.Loss):
    ...
    def __init__(self, border_size, target_shape, from_logits=False, add_dice=False, reduce=None, **kwargs):
